...
const getBotAnswer = (question: string): string => {
    ...
    if (q.includes('телематика') || q.includes('что такое система телематики') || q.includes('что делает система телематики') || q.includes('что она отслеживает')) {
        ...
        return 'Вы можете связаться с нашей поддержкой по телефону:+375 (29) 177-12-11 или по электронной почте: maztelematics@gmail.com.';
    } else {
        return 'Извините, но я не могу ответить на ваш вопрос. Вы можете обратиться к нам по телефону: +375 (29) 177-12-11 или по электронной почте: maztelematics@gmail.com';
    }
};
